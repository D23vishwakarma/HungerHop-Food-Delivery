...
// Fix default marker icon (broken by default in Vite/webpack bundlers)
...
function Checkout() {
    ...
    const position = (location?.lati && location?.long)
        ...
        : [26.7606, 83.3732] // fallback: Gorakhpur

    const subtotal = cartItems.reduce((sum, item) => sum + item.price * item.quantity, 0)
    const deliveryFee = cartItems.length > 100 ? 0 : 25
    ...
    const handlePlaceOrder = async () => {
        ...
        setPlacing(true)
        try {
            // TODO: replace with your actual place-order API call once built
            // await axios.post(`${serverUrl}/order/place`, {
            //     items: cartItems,
            ...
            console.log("Placing order:", { addressInput, location, paymentMethod, cartItems, total })
        } catch (error) {
            console.log(error)
        } finally {
            setPlacing(false)
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 text-sm">Confirm your delivery details and payment method</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                            ...
                            disabled={locating}
                            className="flex items-center gap-1.5 text-xs font-medium text-orange-600 hover:text-orange-700 disabled:opacity-50 transition"
                        >
                    ...
                    <form onSubmit={handleSearch} className="relative mb-3">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-20 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
                        />
                        <button
                            type="submit"
                            disabled={searching}
                            className="absolute right-1.5 top-1/2 -translate-y-1/2 bg-orange-500 hover:bg-orange-600 text-white text-xs font-medium px-3 py-1.5 rounded-md transition disabled:opacity-60"
                        >
                            {searching ? "..." : "Search"}
                        </button>
                    </form>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${
                                paymentMethod === "online" ? "bg-orange-500 text-white" : "bg-gray-100 text-gray-500"
                            }`}>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                    ...
                    <button
                        ...
                        className="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 rounded-lg transition mt-5 disabled:opacity-60 disabled:cursor-not-allowed"
                    >
